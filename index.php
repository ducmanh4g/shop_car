    ...
    <div class="container">
        ...
        <div class="content">
            <div class="col1">
                ...
                <!-- san phẩm -->
                <div class="xe">
                    <h2 style="color: white; display: flex; justify-content: center;">Sản Phẩm</h2>
                    <div class="sanpham">
                        <?php                                                                                    
        ...
        <div style="width:100%; height:100%;display: flex;justify-content: center;align-items: center">
            <div style=" width:600px; height:auto; background-color:rgba(0,0,0,0.9);color:white">
                ...
                <div class="form">
                    ...
                    <div class="inputs">
                        <form action="./view/save/save_ttkhachhang.php" id="form" method="GET"

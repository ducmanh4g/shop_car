...
$sqlkh = "select * from taikhoan where taikhoan = '$taikhoan' AND matkhau = '$matkhau' AND idquyen='2'";
$sqladmin = "select * from taikhoan where taikhoan = '$taikhoan' AND matkhau = '$matkhau' AND idquyen='1'";
